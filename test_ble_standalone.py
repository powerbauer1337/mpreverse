#!/usr/bin/env python3
"""Standalone test script for MarsPro BLE client."""
...
# Import the standalone BLE client
from marspro.ble_client_standalone import (
    MarsProBLEClient,
...
async def test_ble_client():
    ...
    print("Testing MarsPro BLE Client (Standalone)...")
...
if __name__ == "__main__":
    print("MarsPro BLE Client Test Suite (Standalone)")
    print("=" * 50)
